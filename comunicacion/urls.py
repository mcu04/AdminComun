...
urlpatterns = [
    ...
    path('destinatarios/correo-individual/<int:comunidad_id>/', views.enviar_correo_individual, name='enviar_correo_individual'),
    path('correo-masivo/<int:comunidad_id>/', enviar_correo_masivo, name='enviar_correo_masivo'),
    path('comunidad/<int:comunidad_id>/destinatarios/', gestionar_destinatarios, name="gestionar_destinatarios"),
